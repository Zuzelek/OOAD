...
public class FindGuitarTester {
    ...
    private static void initialiseInventory(Inventory inventory) {
        ...
        spec = new GuitarSpec(Builder.GIBSON, "Stratocastor", Type.ELECTRIC, NumStrings.TWELVE, Wood.ALDER, Wood.ALDER);
        inventory.addGuitar("V00002", 1199.99, spec);

        spec = new GuitarSpec(Builder.FENDER, "Stratocastor", Type.ACOUSTIC, NumStrings.SIX, Wood.ALDER, Wood.ALDER);
